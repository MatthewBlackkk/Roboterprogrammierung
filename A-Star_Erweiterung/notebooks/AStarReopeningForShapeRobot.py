...
class ReopenAStar(AStar):
    ...
    def planPath(self, startList, goalList, config):
        ...
        try:
            ...
            # Erweiterung für num_steps variabel -- für 3D Shape Robot
            ...
            # Höheres Limit für 3D: 100.000 statt 10.000
            max_iterations = 100000
            while currentBestName:
                if breakNumber > max_iterations:
                    print(f"ReopenAStar Warnung: Max. Iterationen ({max_iterations}) erreicht. Graph hat {self.graph.number_of_nodes()} Knoten.")
                    break
